...
type RepositoryDependencies struct {
	...
	PullRequestCommentViewer   applicationpullrequest.CommentViewer
	...
	ReleaseDeleter             applicationrelease.Deleter
